...
public static class KeyCodeGroups
{
    public static List<KeyCode> AnyJoystick = new List<KeyCode>
    {
    ...
    public static readonly List<KeyCode> SpecificJoystick = new List<KeyCode>
    {
